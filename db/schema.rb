...
ActiveRecord::Schema.define(version: 20170525112816) do
  ...
  create_table "pengujis", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.integer  "mahasiswa_id"
    t.integer  "dosen_id"
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
  ...
  create_table "scheduled_events", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.datetime "end"
    t.datetime "start"
    t.string   "student_id"
