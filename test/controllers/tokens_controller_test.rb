...
class TokensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create token" do
    assert_difference('Token.count') do
      post tokens_url, params: { token: { owner_id: @token.owner_id, token_json: @token.token_json } }
    end
  ...
  test "should update token" do
    patch token_url(@token), params: { token: { owner_id: @token.owner_id, token_json: @token.token_json } }
